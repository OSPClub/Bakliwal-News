          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: () async {
                        const url =
                            "https://github.com/OSPCommittee/Bakliwal-News";
                        await launchUrl(
                          Uri.parse(url),
                ...
                InkWell(
                  onTap: () async {
                    const url = "https://github.com/OSPCommittee";
                    await launchUrl(
                      Uri.parse(url),
                      mode: LaunchMode.externalApplication,
                    );
                    ...
                    text: TextSpan(
                      children: [
                        ...
                        TextSpan(
                          ...
                          text:
                              "https://github.com/OSPCommittee/Bakliwal-News/blob/main/README.md",
                    ...
                    text: TextSpan(
                      children: [
                        ...
                        TextSpan(
                          style: const TextStyle(color: Colors.lightBlue),
                          text:
                              "https://github.com/OSPCommittee/Bakliwal-News/blob/main/privacy-policy.md",
                          recognizer: TapGestureRecognizer()
                            ..onTap = () async {
                              const url =
                                  "https://github.com/OSPCommittee/Bakliwal-News/blob/main/privacy-policy.md";
                    ...
                    text: TextSpan(
                      children: [
                        ...
                        TextSpan(
                          style: const TextStyle(color: Colors.lightBlue),
                          text:
                              "https://github.com/OSPCommittee/Bakliwal-News/blob/main/CONTRIBUTING.md",
                          recognizer: TapGestureRecognizer()
                            ..onTap = () async {
                              const url =
                                  "https://github.com/OSPCommittee/Bakliwal-News/blob/main/CONTRIBUTING.md";
                    ...
                    text: TextSpan(
                      children: [
                        ...
                        TextSpan(
                          style: const TextStyle(color: Colors.lightBlue),
                          text:
                              "https://github.com/OSPCommittee/Bakliwal-News/blob/main/LICENSE",
                          recognizer: TapGestureRecognizer()
                            ..onTap = () async {
                              const url =
                                  "https://github.com/OSPCommittee/Bakliwal-News/blob/main/LICENSE";
