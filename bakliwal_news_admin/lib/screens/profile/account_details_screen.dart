  ...
  Widget build(BuildContext context) {
    ...
    void saveData() async {
      ...
      try {
        if (userInformation != null) {
          ...
          await FirebaseDatabase.instance
              ...
              .update(
            {
              ...
              "emailId": userInformation.emailId,
              "fullName": fullName ?? userInformation.fullName,
        ...
        await Provider.of<Users>(context, listen: false).fetchAndSetUserData();
                ...
                Column(
                  ...
                  children: [
                    customeFormField(
                      ...
                      fullName = value;
                      if (userInformation.fullName == user?.displayName) {
